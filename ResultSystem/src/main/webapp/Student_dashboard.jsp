...
try {
	...
	.prepareStatement("SELECT id, full_name, course, university FROM registration_form WHERE email = ?");
		...
		<div class="section">
			...
			<div class="info-grid">
				...
				<div class="info-item">
					...
					<form method="get" action="Student_dashboard.jsp"
						style="display: inline;">
						<select name="semester" id="semester"
							onchange="this.form.submit()" style="margin-top: 5px;">
							<option value="1"
								<%="1".equals(selectedSemester) ? "selected" : ""%>>1</option>
							<option value="2"
								<%="2".equals(selectedSemester) ? "selected" : ""%>>2</option>
							<option value="3"
								<%="3".equals(selectedSemester) ? "selected" : ""%>>3</option>
							<option value="4"
								<%="4".equals(selectedSemester) ? "selected" : ""%>>4</option>
							<option value="5"
								<%="5".equals(selectedSemester) ? "selected" : ""%>>5</option>
							<option value="6"
								<%="6".equals(selectedSemester) ? "selected" : ""%>>6</option>
						</select>
					</form>
				</div>
